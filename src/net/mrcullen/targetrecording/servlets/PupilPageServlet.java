...
public class PupilPageServlet extends HttpServlet {
	private static final Logger log = Logger.getLogger(PupilPageServlet.class.getName());
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/pages/pupil.jsp");
